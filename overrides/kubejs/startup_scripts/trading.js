...
let WP = (id, x) => MOD("wildbackport", id, x)
let AB = (id, x) => MOD("auxiliaryblocks", id, x)
...
onEvent('item.registry', event => {
	...
	while (true) {
		...
		simple("Amethyst", MC('amethyst_block', 8), 32, S, 0xC01ED2, 0x750B81)
		simple("Dripstone Block", MC('dripstone_block', 16), 32, S, 0x7F7F7F, 0xD4D4D4)
		simple("Tuff", MC('tuff', 16), 32, S, 0x585858, 0x646363)
		simple("Calcite", MC('calcite', 16), 16, S, 0xC9C4A3, 0xC9C4A3)
		simple("Stone", MC('stone', 16), 3, S, 0x585858, 0x646363)
		simple("Moss Block", MC('moss_block', 16), 3, S, 0x00A82B, 0xADFACB)
		...
		simple("Mangrove Root", WP('mangrove_roots', 4), 9, S, 0x795740, 0xB8AB88)
		...
		simple("Hazard Block", AP('hazard_block', 16), 2, S, 0x211C10, 0x604B43)
		simple("Laboratory Block", AB('lab_chrome', 16), 4, S, 0x71706E, 0x9D9A98)
		...
		simple("Darker Depth's Limestone", DD('limestone', 32), 8, S, 0x756958, 0x7F7360)
